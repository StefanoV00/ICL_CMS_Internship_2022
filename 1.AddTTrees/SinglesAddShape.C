...
void SinglesAddShape () 
{
    ...
    { 
        ...
        XYVector cpvtx1 = XYVector(1001., 1001.);
        //cout<<"cp done"<<endl;
        ...
        XYVector cpvtx0_pr = XYVector(cpx->at(0)/cpz->at(0), 
                                      cpy->at(0)/cpz->at(0));
        XYVector cpvtx1_pr = XYVector(1001, 1001);
        ...
        vector <int> mult_both = (mult->size()>50)?
                                 sum_portions(*mult, 2): //sum halves
                                 *mult; 
